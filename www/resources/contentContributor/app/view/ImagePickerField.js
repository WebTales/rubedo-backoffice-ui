/*
 * File: resources/contentContributor/app/view/ImagePickerField.js
 *
...
Ext.define('ContentContributor.view.ImagePickerField', {
    ...
    onHiddenfieldRender: function(abstractcomponent, options) {
        ...
        myComponent.on("afterrender",function(){
            if (Ext.isEmpty(abstractcomponent.getValue())){
                myComponent.getComponent("fieldImagePreview").setSrc("resources/icones/"+"blue"+"/128x128/image_remove.png");
            } else {
