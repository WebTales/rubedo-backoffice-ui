/*
 * File: app/store/ContributeWorkspacesComboWithAll.js
 *
...
Ext.define('Rubedo.store.ContributeWorkspacesComboWithAll', {
    extend: 'Ext.data.Store',
    alias: 'store.ContributeWorkspacesComboWithAll',
