...
Ext.define('Rubedo.view.EditorialInterface', {
    ...
    processFilterMode: function(config) {
        config.store=[
            [false,Rubedo.RubedoAutomatedElementsLoc.edAll],
            ['[{"property":"live.endPublicationDate","operator":"$ne","value":""},{"property":"live.endPublicationDate","operator":"$lte","value":"'+Math.floor(Date.now() / 1000)+'"}]',Rubedo.RubedoAutomatedElementsLoc.edArchived],
