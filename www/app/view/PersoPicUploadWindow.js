                                ...
                                form.submit({
                                    ...
                                    success: function(form, action) {
                                        ...
                                        if (button.up().up().userMode){
                                            ...
                                            Ext.getCmp("userUpdateCreadentialsForm").targetRecord.set("photo", action.result.data.id);
                                            Ext.getCmp("userCUAdminProfilePicture").setSrc("image/get?file-id="+action.result.data.id);
                                        }
                                        button.up().up().close();
                                    },
