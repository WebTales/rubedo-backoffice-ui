Ext.define('Rubedo.view.override.MyGridPanel28', {
    override: 'Rubedo.view.MyGridPanel28',
    multiSelect: true,
    viewConfig: {
            stripeRows: true,
        ...
        features: [Ext.create('Ext.ux.grid.feature.Tileview', {
			...
			getAdditionalData: function(data, index, record, orig)
			{
	            ...
	            {
	                return "file/get/file-id/"+record.get("id");
	            };
    ...
    tbar: ['->', {
            ...
            listeners: {
                ...
                {
					Ext.getCmp("imagesSpecialGrid").features[0].setView(btn.viewMode);		
                },
                scope: this
            }
        }
