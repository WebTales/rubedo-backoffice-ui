...
Ext.define('Rubedo.controller.MasqueController', {
    ...
    mainBoxSelect: function(component, eOpts) {
        ...
        component.getEl().on("click", function(e){
            ...
            configSpec.getComponent(0).add(Ext.widget('hiddenfield',{
                onChange:function(){

                    component.pageProperties.cauldronConfig=this.getValue();

                },
                id:"cauldronMaskConfig",
            ...
            configSpec.getComponent(0).add(Ext.create('Rubedo.view.ACEFieldCauldron',{
                ...
                labelWidth:60,
                anchor:"100%",
                brotherFieldId:"cauldronMaskConfig",
                margin:"10 0 10 0",
                twigMode:false,
                textMode:true,
                value:component.pageProperties.cauldronInstructions
            }));
            configSpec.getComponent(1).add(Ext.widget('textfield',{
                fieldLabel:"Code",
                onChange:function(){
