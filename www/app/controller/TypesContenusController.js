    ...
    selectChampTC: function(component, eOpts) {
        ...
        TCfield.getEl().on('click', function() {
            ...
            if (Ext.getCmp('champTCIdField').getValue() != TCfield.id) {
                ...
                if ((TCfield.isXType("ImagePickerField"))||(TCfield.isXType("urlField"))||(TCfield.isXType("RDirectObjectField"))||(TCfield.isXType("embeddedImageField"))||(TCfield.isXType("localiserField"))||(TCfield.isXType("externalMediaField"))||(TCfield.isXType("DCEField"))) {
                        ...
                        nouvChamp.on('change', function (thing) {
                            if (thing.isValid()){
                                ...
                                if (this.name=='fieldLabel') {
                                    ...
                                    } else if ((TCfield.isXType("localiserField"))||(TCfield.isXType("urlField"))||(TCfield.isXType("RDirectObjectField"))||(TCfield.isXType("embeddedImageField"))||(TCfield.isXType("externalMediaField"))||(TCfield.isXType("DCEField"))){
